...
class Notice extends Base {
    ...
    public function __construct( ...$args ) {
        ...
        add_filter( 'safe_style_css', [$this, 'wp_kase_style_property_updates'] );
    }
    ...
    public function wp_kase_style_property_updates( $styles ) {
        $styles[] = 'display';
        return $styles;
    }
    ...
    public function display( $force = false ) {
        ...
        printf(
            ...
            ! empty( $content['thumbnail'] ) ? wp_kses( $this->get_thumbnail( $content['thumbnail'] ), $allowed_html ) : '',
            ! empty( $content['html'] ) ? wp_kses( $content['html'], $allowed_html ) : wp_kses( $content, $allowed_html ),
            ! empty( $links ) ? wp_kses( $this->links( $links ), $allowed_html ) : ''
        );
    }
